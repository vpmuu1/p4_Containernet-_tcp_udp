...
# Fake HOST
#ubuntu:trusty
d1 = net.addDocker('d1', cls=P4DockerHost, ip='192.168.1.201',dimage="ub2", mac="00:00:00:00:02:01")

#                   dimage="containernet_example:ubuntup4", mac="00:00:00:00:00:01")
#                   dimage="ubuntu:trusty", mac="00:00:00:00:00:01")
#d1.start()
# HOST
h1 = net.addHost('h1', ip='192.168.1.101', mac="00:00:00:00:01:01")
h2 = net.addHost('h2', ip='192.168.1.102', mac="00:00:00:00:01:02")
h3 = net.addHost('h3', ip='192.168.1.103', mac="00:00:00:00:01:03")
...
# LAMP servers
d2 = net.addDocker('d2', cls=P4DockerHost, ip='192.168.1.202',dimage="ub2", mac="00:00:00:00:02:02")
#                   dimage="containernet_example:lamp", mac="00:00:00:00:00:A0")
#d2.start()
d3 = net.addDocker('d3', cls=P4DockerHost, ip='192.168.1.203',dimage="ub2", mac="00:00:00:00:02:03")
#                   dimage="containernet_example:lamp", mac="00:00:00:00:00:A1")
#d3.start()

info('*** Adding switches\n')

s1 = net.addSwitch('s1', json="./bb1.json", loglevel="debug", pktdump=True)
